...
1. Доступ к фотокамере используется для создания пользовательских снимков.

2. Доступ к галерее устройства используется для использования и редактирования изображения по усмотрению пользователя внутри приложения.

### Контакты

e-mail: bezhko.dev@gmail.com
